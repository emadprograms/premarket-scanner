...
# ==============================================================================
# CONFIGURATION (Moved UP to prevent circular imports)
# ==============================================================================
...
# ==============================================================================
# LOCAL IMPORTS (Moved AFTER Config)
# ==============================================================================
try:
...
def main():
    ...
    # We construct a 'signature' of the current configuration.
    # If this signature changes from the previous run, we wipe the state.
    
    # In Live mode, time flows naturally, so we DON'T include the timestamp in the signature.
    # Otherwise, the app would reset every second.
    # In Simulation mode, the timestamp IS the input, so we DO include it.
    if mode == "Simulation":
