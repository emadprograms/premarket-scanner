  ...
  return (
    <div className="space-y-8 mx-auto px-4 relative animate-in fade-in duration-500">
      ...
      {isBackendError ? (
        ...
        <LayoutGroup>
          <div className="grid gap-4 animate-in fade-in slide-in-from-right-4 duration-500" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))' }}>
      ...
      <Modal
        ...
        variant="default"
        hideTitle={true}
        maxWidthClass={modalView === 'chart' ? 'max-w-[95vw]' : 'max-w-4xl'}
      >
